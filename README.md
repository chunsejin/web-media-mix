...
웹툰, 웹 소설, 웹드라마 등 웹 콘텐츠 시장이 전 세계적으로 증가하고 있습니다. 만화책을 위한 Comic Book ontology처럼 단일 매체용 정보 모델은 존재했지만, 미디어 믹스로 인해 기존의 정보 모델로 설명 불가능한 관계가 등장했습니다. 예시로는, 웹툰의 드라마화로 인한 웹툰의 등장인물과 드라마 배우 간의 관계 등이 있습니다. 이런 관계를 효과적으로 검색/질의/구독하기 위한 정보 데이터 모델은 존재하지 않습니다. 따라서 관계 및 속성에 대한 개념을 공유/개방 가능한 형태로 모델링하고자 합니다.
