...
# 미디어 믹스의 역할
미디어를 그 역할에 따라 구분하면 세 가지로 구분할 수 있다. Originator, Assist, Converter로 구분한다.  
  
**Originator** - 고객으로 하여금 브랜드를 인지할 수 있도록 매개하는 성격의 미디어  
**Assist** - 브랜드에 대한 신뢰를 높이는 데 도움이 되는 미디어  
**Converter** - 전환으로 연결시키는 역할의 미디어  
  
이 세가지 요소를 적절하게 조합시켜 좋은 효과를 얻을 수 있다.  
출처:https://brunch.co.kr/@pyggal/41
