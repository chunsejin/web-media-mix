...
# 메타 데이터란?
대량의 정보 가운데에서 찾고 있는 정보를 효율적으로 찾아내서 이용하기 위해 일정한 규칙에 따라 컨텐츠에 대하여 부여되는 데이터이다. 사례로는 디지털 음원시장, 차세대 스마트 방송, 소셜 네트워크가 있다
(출처: https://blog.naver.com/PostView.nhn?blogId=sundooedu&logNo=221351641409)
# 현재 단계 및 향후 방향
